...
**Objective:** Serve as a quick Julia code reference manual (online and **[offline](pages/data_used.qmd)**) with task-centered examples that address common epidemiological problems.  
...
* You can follow-along with [the example data](pages/data_used.qmd)

**Offline version**  

See instructions in the [Download handbook and data](pages/data_used.qmd) page.
